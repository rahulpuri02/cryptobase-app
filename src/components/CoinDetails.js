...
const CoinDetails = () => {
    ...
    let {coinData:coin, getCoinData, currency} = useContext(CryptoContext);
  ...
  return ReactDOM.createPortal(
    ...
    onClick={close}>
        <div onClick={(e) => e.stopPropagation()} className=' w-full h-full sm:w-[95%] md:w-[85%] md:h-[75%] lg:w-[60%] bg-gray-300 bg-opacity-75 rounded-lg text-white relative'>
        {
           ...
           {/*Left Side */}
             ...
             <div className='flex w-full mt-6 '>
                <div className='flex flex-col w-full'>
                    <div className='flex justify-between'>
                       ...
                       ${coin.market_data.price_change_percentage_24h > 0 ? 'bg-green text-green' : 'bg-red text-red'} `}><span>{Number(coin.market_data.price_change_percentage_24h).toFixed(2)}%</span>
                       
                       <svg className={`w-4 ml-2
                       ${coin.market_data.price_change_percentage_24h > 0 ? 'fill-green rotate-180' : 'fill-red'} `}
            ...
            <div>
                ...
                <h2 className='text-sm font-semibold'>{new Intl.NumberFormat("en-IN", {
                      ...
                      currency: currency,
                      notation: "compact",
                    }).format(coin.market_data.fully_diluted_valuation[currency])}</h2>
            </div>
             </div>
             ...
             <div className='flex flex-col w-full mt-4 justify-between'>
                ...
                <h2 className='text-sm font-semibold'>{new Intl.NumberFormat("en-IN", {
                      ...
                      currency: currency,
                      minimumFractionDigits: 0,
                    }).format(coin.market_data.total_volume[currency])}</h2>
             </div>
            ...
            <div className='flex flex-col'>
                ...
                <h2 className='text-sm md:text-base font-semibold'>{new Intl.NumberFormat("en-IN", {
                    ...
                    }).format(coin.market_data.low_24h[currency])}</h2>
            </div>
            <div>
                ...
                <h2 className='text-sm md:text-base font-semibold'>{new Intl.NumberFormat("en-IN", {
                      ...
                      currency: currency,
                      maximumFractionDigits:1,
                    }).format(coin.market_data.high_24h[currency])}</h2>
            </div>
          ...
          `}>
                      <span>
                        {Number(coin.sentiment_votes_down_percentage).toFixed(
                          2
                        )}
                        %
                      </span>
